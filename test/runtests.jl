...
satRuleDirectory = joinpath(@__DIR__, "..", "outputs", "test_SAT_rules")
...
kygridDirectory = joinpath(@__DIR__, "..", "outputs", "test_kygrid")
...
testTMDirectory = joinpath(@__DIR__, "..", "outputs", "test_TM")
