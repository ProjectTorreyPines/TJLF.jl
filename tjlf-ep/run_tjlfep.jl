...
"""
run is a function meant for usage in a separated main.jl file. There should eventually be usage with a gacode file since
that would be easier.

inputs: tglfepfilepath, mtglffilepath encoding info of the locations of the executed inputs
"""
function run(tglfepfilepath::String, mtglffilepath::String)
